...
file = os.path.join("NLP LAB\corpus_for_language_models.txt")
with open(file) as f:
...
print("Trigram probabilities for the language model without smoothing\n")
...
print("(c) Total probabilities with Katz back-off smoothing \n")
